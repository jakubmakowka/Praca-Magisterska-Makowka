...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$username || !$password || !$email) {
        $result = "Proszę wypełnić wszystkie pola!";
    } elseif (!preg_match('/^[a-zA-Z0-9]+$/', $username)) {
        $result = "Nazwa użytkownika może zawierać tylko litery i cyfry!";
    } elseif (strlen($password) < 5 || strlen($password) > 20) {
        $result = "Hasło musi mieć od 5 do 20 znaków!";
    } else {
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="position-absolute w-40 top-0 start-0 h-100 d-md-block d-none">
                <div class="oblique-image position-absolute d-flex fixed-top ms-auto h-100 z-index-0 bg-cover me-n8" style="background-image:url('../assets/img/signin.jpg')">
                  <div class="my-auto text-start max-width-350 ms-7">
                    <?php echo '<h1 class="mt-3 text-white font-weight-bolder"><br>'.$result.'</h1>'; ?>
                  </div>
                  <div class="text-start position-absolute fixed-bottom ms-7">
                    <h6 class="text-white text-sm mb-5">Copyright © 2025 Jakub Makówka</h6>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" action="register.php" method="post">
                    ...
                    <div class="mb-3">
                      <input type="email" class="form-control" placeholder="Wprowadź adres email skrzynki" aria-label="Email" aria-describedby="email-addon" name="email" id="email" required>
                    </div>
                    <label>Hasło</label>
                    <div class="mb-3">
                    ...
                    <div class="form-check form-check-info text-left mb-0">
                      ...
                      <label class="font-weight-normal text-dark mb-0" for="flexCheckDefault">
                        Akceptuję <a href="https://www.creative-tim.com/product/corporate-ui-dashboard" class="text-dark font-weight-bold">regulamin</a>.
                      </label>
                    </div>
                    <div class="text-center">
                      ...
                      <button type="button" class="btn btn-white btn-icon w-100 mb-3">
                        ...
                        <span class="btn-inner--text">Zarejestruj się przy użyciu Google</span>
                      </button>
                    </div>
                  </form>
                </div>
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-xs mx-auto">
                    Masz już konto?
                    <a href="./sign-in.html" class="text-dark font-weight-bold">Zaloguj się</a>
                  </p>
                </div>
              </div>
            </div>
